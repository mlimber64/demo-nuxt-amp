...
export default {
    ...
    data() {
        return {
            ...
            totalItems: 140,
            currentPage: 1,
            listTemplate: `<template type="amp-mustache">
                                <div class="movie">
                                    <amp-img src="{{Poster}}" width="197" height="310" layout="responsive" alt="a sample poste" />
                                </div>
                            </template>`
        }
    },
    ...
    async asyncData() {
        ...
        const movies = res.Sereach
        const totalItems = parseInt(res.totalItems)
        return {
            movies,
            totalItems
        }
